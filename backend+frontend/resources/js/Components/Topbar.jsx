...
export default function Topbar({query,akun}){
  const user = akun
  console.log("topbar hehe",akun);
        ...
        <ul>
          ...
          { user ? (
            ...
            <li class="navbar-user-item">
              ...
              <ul class="dropdown">
                {user.role == "admin" ? (
              <Link className="option w-100"href={route('admin-movies')}><li>Dashboard</li></Link>
                ) : (
                  <Link className="option w-100"href={route('admin-input_movie')}><li>Add Movie</li></Link>
                )}
