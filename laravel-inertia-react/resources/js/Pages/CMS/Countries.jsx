...
//         // Atau panggil API untuk filter data berdasarkan `searchQuery`
//     };

//     return (
//         <div>
//             <Head title={title || 'Countries'} />
//             <SidebarCMS>
//                 <h2>Countries</h2>
//                 <div className="container-fluid">
//                     <div className="d-flex justify-content-between align-items-center mb-3">
//                         <button onClick={toggleModal} className="btn btn-outline-secondary">
//                             <FaPlus />
//                         </button>
//                     </div>
...
const Countries = ({ title }) => {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        // Filter data `countries` berdasarkan `searchQuery`
